...
import AccountStatementModal from '@/components/user/AccountStatementModal'
  ...
  return (
    <div>
      ...
      <div className="w-11/12 mx-auto mt-1">
        ...
        className="bg-white mb-2 px-3 py-4 flex cursor-pointer">
          <div className="">
        ...
        <Link href="/settings" className="bg-white mb-2 px-3 py-4 flex cursor-pointer">
          <div className="">
