...
const rows = [
    { name: 'John willson', amount: "$300,000", description: 'Deposited from wema bank into account', status: 'completed', date: '10/20/2024 05:20 AM' },
    { name: 'John willson', amount: "$300,000", description: 'Deposited from wema bank into account', status: 'pending', date: '10/20/2024 05:20 AM' },
    { name: 'John willson', amount: "$300,000", description: 'Deposited from wema bank into account', status: 'completed', date: '10/20/2024 05:20 AM' },
    { name: 'John willson', amount: "$300,000", description: 'Deposited from wema bank into account', status: 'completed', date: '10/20/2024 05:20 AM' },
    { name: 'John willson', amount: "$300,000", description: 'Deposited from wema bank into account', status: 'failed', date: '10/20/2024 05:20 AM' },
    { name: 'John willson', amount: "$300,000", description: 'Deposited from wema bank into account', status: 'failed', date: '10/20/2024 05:20 AM' },
    { name: 'John willson', amount: "$300,000", description: 'Deposited from wema bank into account', status: 'completed', date: '10/20/2024 05:20 AM' },
    { name: 'John willson', amount: "$300,000", description: 'Deposited from wema bank into account', status: 'completed', date: '10/20/2024 05:20 AM' },
    { name: 'John willson', amount: "$300,000", description: 'Deposited from wema bank into account', status: 'pending', date: '10/20/2024 05:20 AM' },
        ...
        <div className='w-11/12 mx-auto mt-5'>
            ...
            <div className="bg-primary p-4">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="">
                        <div className="text-white text-xl font-semibold text-left lg:text-right">Total Deposits</div>
