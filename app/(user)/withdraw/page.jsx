    ...
    return (
        <div className='w-11/12 mx-auto max-w-3xl mt-10'>
            ...
            {screen === 0 && <div className="bg-white px-5 py-10 mt-10">
                ...
                <Forminput label="Account Holder" />
                <Forminput label="Amount to send" />
                <Forminput label="Description" formtype="textarea" />
                <div className="">
            ...
            {screen === 1 && <div className="bg-white px-5 py-10 mt-10">
                <div className="mb-5">
                    ...
                    <div className="grid grid-cols-2 py-3.5 border-b">
                        <div className="text-zinc-500">Account Details:</div>
                        <div className="">
                            <div className="text-right font-bold">Financial bank institution</div>
                            <div className="text-right text-zinc-500 font-bold">97807060605505</div>
                        </div>
                    </div>
                    <div className="grid grid-cols-2 py-3.5 border-b">
                    ...
                    <div className="grid grid-cols-2 py-3.5 border-b">
                        <div className="text-zinc-500">Withdrawal Amount:</div>
                        <div className="text-right font-bold">$300,000</div>
                    </div>
                    <div className="grid grid-cols-2 py-3.5 border-b">
                        <div className="text-zinc-500">Withdrawal Fee:</div>
            ...
            {screen === 3 && <div className="bg-white px-5 py-10 mt-10">
                <div className="flex flex-col items-center justify-center gap-3">
                    ...
                    <Lottie
                        ...
                        loop={false}
                    />
                    <div className="text-center text-green-600 font-semibold text-3xl">Withdrawal Completed!</div>
                    <div className="mb-2">
                        <div className="grid grid-cols-2 py-3.5 border-b">
                            <div className="text-zinc-500">Account Holder:</div>
                            <div className="text-right font-bold">williams okonjo</div>
                        ...
                        <div className="grid grid-cols-2 py-3.5 border-b">
                            <div className="text-zinc-500">Amount Debited:</div>
                            <div className="text-right font-bold">$300,000</div>
                        </div>
                        <div className="grid grid-cols-2 py-3.5 border-b">
